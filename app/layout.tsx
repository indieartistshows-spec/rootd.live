...
export const metadata: Metadata = {
  ...
  description: 'Get your signal link. Share it with your audience. See real demand before you book anything.',
  openGraph: {
    title: "Rootd Live — Don't Perform to Empty Rooms",
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <body className={`${anton.variable} ${spaceGrotesk.variable} ${dmMono.variable} ${archivoblack.variable}`}>
        {children}
      </body>
    </html>
  )
